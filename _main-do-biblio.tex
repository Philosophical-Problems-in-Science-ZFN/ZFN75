...
\usepackage{geometry}
\geometry{verbose,paperwidth=750mm,paperheight=1013mm,landscape=false,
...
\addbibresource{EDI_Wright/editorial.bib}
...
\addbibresource{REV_Muntean/Muntean.bib}
\addbibresource{REV_Malfatti/Malfatti.bib}
...
\input{ART_Karadimas/Karadimas.tex}
\input{ART_Hochstein/Hochstein.tex}
\input{ART_Gim/Gim.tex}
\input{ART_Povich/Povich.tex}
\input{ART_Brandelet/Brandelet.tex}
\input{ART_Oleksowicz/Oleksowicz.tex}
...
\input{REV_Barman/Barman.tex}
\input{REV_Muntean/Muntean.tex}
\input{REV_Malfatti/Malfatti.tex}
